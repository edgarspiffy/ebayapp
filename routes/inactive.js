...
//ADD PRODUCT TO DATABASE WITH ACTIVE PROPERTY..........ROUTER POST TO /inactive
...
//DISPLAY ROUTE FOR ACTIVE PRODUCTS...........ROUTE IS /inactive
...
//UPDATE SELLING PRICE ON INACTIVE DISPLAY ROUTE.....ROUTE IS /inactive/:id
...
router.get('/product/:id',function(req,res){
    Product.findById(req.params.id,function(err,product){
        if(err){
            ...
            res.render('inactive_product',{product:product});
        }
    });
});

//EDIT SELLING PRICE FROM INDIVIDUAL PRODUCT PAGE.......ROUTE IS /inactive/product:id
...
//TOOGLE ROUTE TO MAKE ITEMS ACTIVE OR INACTIVE....ROUTE IS /inactive/toggle/:id
